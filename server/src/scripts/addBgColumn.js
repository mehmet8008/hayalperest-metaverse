...
async function addBgColumn() {
  try {
    // Add current_bg column to avatars table with DEFAULT 'DEFAULT'
    await db.query(
      "ALTER TABLE avatars ADD COLUMN current_bg VARCHAR(50) DEFAULT 'DEFAULT'"
    );
